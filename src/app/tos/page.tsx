...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to SOMCV. These Terms of Service (&quot;Terms&quot;)
        govern your use of our website and services, including any paid
        subscription plans. By accessing or using SOMCV (&quot;the
        Service&quot;), you agree to be bound by these Terms. If you do not
        agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        SOMCV is a SaaS platform that provides resume-building tools
        powered by artificial intelligence. We offer both a free tier and paid
        subscription plans (&quot;Paid Plans&quot;). Subscription requests are
        processed manually via WhatsApp.
      </p>
      ...
      <p>
        If you choose to upgrade to a Paid Plan, you will be required to submit
        a subscription request via WhatsApp. All subscription requests are
        processed manually by our admin team. By submitting a subscription
        request, you agree to the following terms:
      </p>
      <ul className="list-inside list-disc">
        <li>
          <strong>Subscription Request:</strong> You must provide your full name
          and phone number to request a subscription. Your request will be
          reviewed and approved by our admin team.
        </li>
        <li>
          <strong>Approval Process:</strong> Subscription requests are reviewed
          manually. Approval may take some time. You will be notified once your
          request is approved or rejected.
        </li>
        <li>
          <strong>Refund Policy:</strong> SOMCV does not offer
          refunds for any subscriptions already approved. However, you can
          contact support to cancel your subscription at any time.
        </li>
      </ul>
      <h2 className="text-xl font-semibold">6. Cancelation of Subscription</h2>
      <p>
        You can cancel your subscription at any time by contacting support via
        WhatsApp. Cancelation will take effect immediately upon confirmation.
      </p>
      ...
      <p>
        SOMCV grants you a limited, non-exclusive, non-transferable,
      ...
      <p>
        ...
        SOMCV are owned by SOMCV or its licensors. You
        agree not to infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant SOMCV a non-exclusive,
      ...
      <p>
        ...
        services (e.g., WhatsApp for subscription requests). SOMCV is not
      ...
      <p>
        ...
        available&quot; basis. SOMCV makes no warranties, express or
      ...
      <p>
        To the fullest extent permitted by law, SOMCV shall not be
      ...
      <p>
        By using SOMCV, you acknowledge that you have read,
